          ...
          <WorkspaceProvider>
            <WorkspaceAuthorizationProvider>
              <Routes>
                ...
                <Route
                  path="/creator/login"
                  element={<PortalAuth persona="CREATOR" mode="login" />}
                />
                <Route
                  path="/creator/register"
                  element={<PortalAuth persona="CREATOR" mode="register" />}
                />
                <Route
                  path="/brand/coming-soon"
                  element={<BrandComingSoon />}
                />
                <Route
                  path="/brand/login"
                  element={
                    <BrandPortalRouteGuard>
                      <PortalAuth persona="BRAND" mode="login" />
                    </BrandPortalRouteGuard>
                  }
                />
                <Route
                  ...
                  element={
                    <BrandPortalRouteGuard>
                      <PortalAuth persona="BRAND" mode="register" />
                    </BrandPortalRouteGuard>
                  }
                />
                ...
                >
                  ...
                  <Route
                    ...
                    element={<CreatorInvoices />}
                  />
                  <Route
                    path="/creator/invoices/new"
                    element={<CreatorInvoiceForm />}
                  />
                  <Route
                    path="/creator/invoices/:invoiceId"
                    element={<CreatorInvoiceDetail />}
                  />
                  <Route
                    path="/creator/invoices/:invoiceId/edit"
                    element={<CreatorInvoiceForm />}
                  />
                  ...
                  <Route
                    path="/creator/scripts/new"
                    element={<CreatorScriptNew />}
                  />
                  <Route
                    path="/creator/scripts/:projectId"
                    element={<CreatorScriptDetail />}
                  />
                ...
                >
                  <Route
                    ...
                    element={
                      <WorkspacePermissionGuard permission="CONNECTION_USE">
                        <CreatorMarketplace />
                  ...
                  <Route
                    path="/brand/lists"
                    element={
                      <WorkspacePermissionGuard permission="CREATOR_LIST_VIEW">
                        <CreatorLists />
                      </WorkspacePermissionGuard>
                    }
                  />
                  <Route
                    ...
                    element={
                      <WorkspacePermissionGuard permission="CAMPAIGN_VIEW">
                        <Campaigns />
                      </WorkspacePermissionGuard>
                    }
                  />
                ...
                <Route
                  ...
                  element={
                    <PersonaRoute persona="CREATOR">
                      <WorkspacePermissionGuard permission="ANALYTICS_VIEW">
                        <Insights />
                      </WorkspacePermissionGuard>
                    </PersonaRoute>
                  }
                ...
                <Route
                  ...
                  element={
                    <BrandPortalRouteGuard>
                      <PersonaRoute persona="BRAND">
                        <WorkspacePermissionGuard permission="OUTREACH_TASK_VIEW">
                          <FollowUps />
                        </WorkspacePermissionGuard>
                      </PersonaRoute>
                    </BrandPortalRouteGuard>
                ...
                />
                <Route
                  path="/settings/outreach-templates"
                  element={
                    <BrandPortalRouteGuard>
                      <PersonaRoute persona="BRAND">
                        <WorkspacePermissionGuard permission="OUTREACH_TEMPLATE_VIEW">
                          <OutreachTemplates />
                        </WorkspacePermissionGuard>
                      </PersonaRoute>
                    </BrandPortalRouteGuard>
                ...
                <Route
                  ...
                  element={
                    <BrandPortalRouteGuard>
                      <ProtectedRoute>
                        <BrandCollaborationRoute>
                          <WorkspacePermissionGuard permission="WORKSPACE_VIEW">
                            <WorkspaceSettings />
                          </WorkspacePermissionGuard>
                        </BrandCollaborationRoute>
                      </ProtectedRoute>
                ...
                <Route
                  ...
                  element={
                    <BrandPortalRouteGuard>
                      <ProtectedRoute>
                        <BrandCollaborationRoute>
                          <WorkspacePermissionGuard permission="MEMBER_VIEW">
                            <Members />
                          </WorkspacePermissionGuard>
                        </BrandCollaborationRoute>
                      </ProtectedRoute>
