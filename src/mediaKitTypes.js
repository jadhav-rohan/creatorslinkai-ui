...
/** @typedef {{brandName:string,evidenceUrl:string|null}} MediaKitBrandCollaboration */
...
/** @typedef {{exists:boolean,complete:boolean,id:string|null,workspaceId:string,about:string|null,currency:string,pricing:MediaKitPricing,brandsWorkedWith:string[],brandCollaborations:MediaKitBrandCollaboration[],contact:{email:string|null,phone:string|null},preview:MediaKitPreview,createdAt:string|null,updatedAt:string|null}} MediaKitResponse */
