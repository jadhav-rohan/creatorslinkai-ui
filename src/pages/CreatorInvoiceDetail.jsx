import {useState} from "react";import {Link,useNavigate,useParams} from "react-router-dom";import {api} from "../api";import {useCreatorInvoiceAccess} from "../hooks/useCreatorInvoiceAccess";import {useInvoice} from "../hooks/useInvoices";import {invoiceService} from "../services/invoiceService";import {InvoiceBack,InvoiceGate,LoadError,Status,cash,dateOnly} from "../components/InvoiceShared";
