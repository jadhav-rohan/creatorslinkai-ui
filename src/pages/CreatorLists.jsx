...
export default function CreatorLists() {
  ...
  async function save(event) {
    event.preventDefault(); if (!canEdit || submitting || !name.trim()) return; setSubmitting(true); setError(null);
    try {
      if (editing) {
