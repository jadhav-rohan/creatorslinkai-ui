      ...
      <div className="relative z-10 w-full max-w-md p-8 md:p-10 rounded-3xl bg-panel/50 backdrop-blur-xl border border-panel-border shadow-2xl transition-all duration-300 hover:border-panel-border/80">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-semibold tracking-widest text-accent-secondary uppercase">CreatorLinksAI</span>
          </div>
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-text-primary">Create account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-[10px] text-text-secondary/60">Min. 8 characters</span>
            </div>
            <input
              id="password"
              type="password"
        ...
        <p className="mt-8 text-center text-xs text-text-secondary">
          ...
          <Link to="/login" className="font-semibold text-accent-primary hover:text-accent-secondary transition-colors underline underline-offset-4">
            Log in here
          </Link>
        </p>
      </div>
