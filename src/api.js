...
export const api = {
  ...
  generateCreatorScript: (workspaceId, payload, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/generate`, {method:"POST",body:payload,token}),
  listCreatorScripts: (workspaceId, token, options) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts`, {token,...options}),
  getCreatorScriptUsage: (workspaceId, token, options) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/usage`, {token,...options}),
  getCreatorScript: (workspaceId, projectId, token, options) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}`, {token,...options}),
  updateCreatorScript: (workspaceId, projectId, payload, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}`, {method:"PATCH",body:payload,token}),
  deleteCreatorScript: (workspaceId, projectId, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}`, {method:"DELETE",token}),
  updateCreatorScriptVariation: (workspaceId, projectId, variationId, payload, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}/variations/${encodeURIComponent(variationId)}`, {method:"PATCH",body:payload,token}),
  selectCreatorScriptVariation: (workspaceId, projectId, variationId, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}/variations/${encodeURIComponent(variationId)}/select`, {method:"POST",token}),
  regenerateCreatorScript: (workspaceId, projectId, feedback, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}/regenerate`, {method:"POST",body:feedback?{feedback}:undefined,token}),
  regenerateCreatorScriptVariation: (workspaceId, projectId, variationId, feedback, token) => request(`/api/v1/creator/workspaces/${encodeURIComponent(workspaceId)}/scripts/${encodeURIComponent(projectId)}/variations/${encodeURIComponent(variationId)}/regenerate`, {method:"POST",body:feedback?{feedback}:undefined,token}),
