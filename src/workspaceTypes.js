/** @typedef {{id:string,name:string,personal:boolean,type:'PERSONAL'|'BRAND'|'AGENCY'|'CREATOR'|'CREATOR_TEAM',role:'OWNER'|'ADMIN'|'CAMPAIGN_MANAGER'|'ANALYST'|'MEMBER',logoUrl?:string,website?:string,industry?:string,country?:string,timezone?:string,contactEmail?:string,description?:string,createdAt:string,updatedAt:string}} Workspace */
